...
def round DOVIEWCHANGE:
  ...
  if (!(((old_0_vround == STARTVIEWCHANGE) && (old_0_p == primary(view, n))) && (count_messages(mbox, view, STARTVIEWCHANGE, NULL, NULL) > f)) && (((old_2_vround == STARTVIEWCHANGE) && (old_2_p != primary(view, n))) && (count_messages(mbox, view, STARTVIEWCHANGE, NULL, NULL) > f)))
  {
